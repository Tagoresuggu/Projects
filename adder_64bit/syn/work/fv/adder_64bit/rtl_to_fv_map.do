...
# Generated on: Sat Jan 25 11:26:03 PST 2025 (Sat Jan 25 19:26:03 UTC 2025)
...
set logfile fv/adder_64bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/adder_64bit -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/adder_64bit.sv
elaborate_design -golden -root {adder_64bit} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/adder_64bit/fv_map.v.gz
elaborate_design -revised -root {adder_64bit}
...
set_analyze_option -mapping_file fv/adder_64bit/fv_map.map.do
...
write_compared_points noneq.compared_points.adder_64bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.adder_64bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.adder_64bit.rtl.fv_map.rpt
