...
# Generated on: Mon Feb 24 21:41:46 PST 2025 (Tue Feb 25 05:41:46 UTC 2025)
...
set logfile fv/mixColumns_InvmixColumns/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mixColumns_InvmixColumns -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/mixColumns_InvmixColumns.sv
elaborate_design -golden -root {mixColumns_InvmixColumns} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mixColumns_InvmixColumns/fv_map.v.gz
elaborate_design -revised -root {mixColumns_InvmixColumns}
...
set_analyze_option -mapping_file fv/mixColumns_InvmixColumns/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mixColumns_InvmixColumns.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mixColumns_InvmixColumns.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mixColumns_InvmixColumns.rtl.fv_map.rpt
